    ...
    def test(self):
        ...
        for items in test_loader:
            ...
            if model == 2:
                ...
                n_parameters = sum(p.numel() for p in self.inpaint_model.parameters() if p.requires_grad)
                ...
                path_masked = os.path.join(self.results_path,self.model_name,'masked20')
                path_result = os.path.join(self.results_path, self.model_name,'result20')
                path_joint = os.path.join(self.results_path,self.model_name,'joint20')
